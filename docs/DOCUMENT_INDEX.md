...
当前 `v2.5.15` 已从精确提交生成本地不可变候选；维护人于2026-08-06确认该版本已于2026-08-05上传、审核通过并正式发布。仍未完成同提交CI、绑定该候选的正式双真机记录、平台构建号/时间/截图、正式线上数据回读或稳定归档。本仓库后续不执行额外上传、审核、发布、部署或稳定归档，除非取得新的明确授权；旧版本证据不得用于关闭当前版本门禁。候选身份和待补证据见 [`MINIPROGRAM_V2_5_15_RELEASE_HANDOFF.md`](MINIPROGRAM_V2_5_15_RELEASE_HANDOFF.md)。
