...
- 最终同步后小程序99项测试再次通过；源目录与微信开发者工具目录的应用文件逐文件SHA-256一致。当前预览包为1,594,604字节。
- `2.3.0` 已由微信开发者工具CLI上传到 AppID `wxf2b2a44f4c788def` 的开发版本区，上传命令成功退出并生成1,603,516字节包体信息；尚未在公众平台设为体验版，也未提交审核或公开发布。
