...
test('prepare and recovery branches contain no production object writes', async () => {
  ...
  const finalizationBranch = script.slice(script.indexOf('async function finalizePreparedIntent'), script.indexOf('async function applyPreparedIntent'))
  ...
  assert.doesNotMatch(finalizationBranch, /putObject|updateFunctionCode/)
