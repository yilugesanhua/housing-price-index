...
try {
  ...
  const gateReport = {
    ...
    cloud_slot_id: discoveryGate.cloud_slot_id,
    cloud_observation_id: discoveryGate.cloud_observation_id,
    cloud_observation_payload_sha256: discoveryGate.cloud_observation_payload_sha256,
    cloud_timing_status: discoveryGate.cloud_timing_status,
    cloud_handoff_identity: discoveryGate.cloud_handoff_identity,
